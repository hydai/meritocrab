...
///
/// ```
/// use sc_core::credit::calculate_delta;
...
///
/// ```
/// use sc_core::credit::calculate_delta_with_config;
/// use sc_core::config::{EventType, QualityLevel, RepoConfig};
///
/// let config = RepoConfig::default();
/// assert_eq!(
...
///
/// ```
/// use sc_core::credit::apply_credit;
///
