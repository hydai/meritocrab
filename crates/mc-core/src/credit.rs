...
///
/// ```
/// use mc_core::credit::calculate_delta;
/// use mc_core::config::{EventType, QualityLevel};
///
...
///
/// ```
/// use mc_core::credit::calculate_delta_with_config;
/// use mc_core::config::{EventType, QualityLevel, RepoConfig};
///
/// let config = RepoConfig::default();
/// assert_eq!(
...
///
/// ```
/// use mc_core::credit::apply_credit;
///
